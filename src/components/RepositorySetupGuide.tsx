    ...
    <>
      ...
      <Box sx={{ my: 2 }}>
        <Typography variant="body1" component="div">
          1. Click on <strong>Settings</strong> icon in the upper-right corner
        ...
        <Typography variant="body1" component="div">
          5. Click <strong>Select All</strong> or <strong>Remove All</strong>{" "}
          button to select or deselect all repositories.
        </Typography>
        <Typography variant="body1" component="div">
